...
<div id="contenu">
    <?php
        ...
        while($result = mssql_fetch_array($executed_query))
        {
            ...
            echo "<a href=\"saisie_note.php?note=".$result[0]."\" onmouseover=\"showInfoNote('#info_note".$result[0]."', true);\" onmouseout=\"showInfoNote('#info_note".$result[0]."', false);\" class=\"button blue\">".base64_decode($result[2])."</a>";
